...
public class ZMQ
{
    ...
    */
    ...
    public static class Socket implements Closeable
    {
         ...
         * The reconnection interval is the period 脴MQ shall wait between attempts to reconnect
         * disconnected peers when using connection-oriented transports.
         * The value -1 means no reconnection.
         *
         * CAUTION: The reconnection interval may be randomized by 脴MQ to prevent reconnection storms in topologies with a large number of peers per socket.
         *
         ...
         * The reconnection interval is the period 脴MQ shall wait between attempts
         ...
         * This is the maximum period 脴MQ shall wait between attempts to reconnect.
         ...
         * The high water mark is a hard limit on the maximum number of outstanding messages 脴MQ
         ...
         * 脴MQ shall take appropriate action such as blocking or dropping sent messages.
         ...
         * Refer to the individual socket descriptions in zmq_socket(3) for details on the exact action taken for each socket type.
         *
         * CAUTION: 脴MQ does not guarantee that the socket will accept as many as ZMQ_SNDHWM messages,
         ...
         * That means the full message is (request id, identity, 0, user frames鈥�).
        ...
        */
         ...
         * it will read and write TCP data without 脴MQ framing.
         * This lets 脴MQ applications talk to non-脴MQ applications.
